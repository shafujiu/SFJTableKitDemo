...
class BaseScrollView: UIScrollView {
    ...
    private var p_emptyShouldDisplay: (()->(Bool))?
    /// 过渡占位  loading
...
extension BaseScrollView: TableEmptyable {
...
extension BaseScrollView: EmptyDataSetSource, EmptyDataSetDelegate {
...
extension BaseScrollView {
    ...
    func setEmptyShouldDisplay(_ block: (()->(Bool))?) {
        p_emptyShouldDisplay = block
    }
}
